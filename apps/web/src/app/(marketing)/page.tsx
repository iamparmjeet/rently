					...
					<div className="container mx-auto px-4">
						...
						<div className="mt-16 grid gap-8 md:grid-cols-3">
							{steps.map((step) => (
								...
								>
									<span className="font-bold text-6xl text-muted/20">
										{step.number}
									</span>
									<h3 className="mt-2 font-semibold text-xl">{step.title}</h3>
				...
				<section className="py-20">
					<div className="container mx-auto px-4">
						<div className="rounded-2xl bg-primary px-6 py-16 text-center md:px-16">
							<h2 className="font-bold text-3xl text-primary-foreground tracking-tight md:text-4xl">
				...
				<section className="bg-muted/50 py-20">
					<div className="container mx-auto px-4">
						<div className="grid items-center gap-12 lg:grid-cols-2">
							...
							<div className="rounded-xl border bg-linear-to-br from-primary/5 to-primary/10 p-8">
								<div className="space-y-6">
									...
									<div className="flex items-center justify-between">
										...
										<span className="font-bold text-2xl">₹12Cr+</span>
									</div>
								</div>
							</div>
						</div>
